...
source_line_start: 3051
source_line_end: 3176
source_heading: "24　跨实验综合：稳定结论、被限定主张与系统 Design Delta"
---

> 本文件是导航用派生视图。原始文本未改动；引用研究证据时应回到上列源文件与行号。

# 24　跨实验综合：稳定结论、被限定主张与系统 Design Delta
